...
MINCImageIO::Read(void * buffer)
{
  ...
  switch (this->GetComponentType())
  {
    ...
    case IOComponentEnum::DOUBLE:
      ...
      break;
    default:
      itkDebugMacro(<< "Could read datatype " << itkExposeEnumValue(this->GetComponentType()));
      delete[] start;
      delete[] count;
      return;
  }
...
MINCImageIO::WriteImageInformation()
{
  ...
  switch (this->GetComponentType())
  {
    ...
    case IOComponentEnum::DOUBLE: // TODO: make sure we are cross-platform here!
      ...
      break;
    default:
      itkExceptionMacro(<< "Could read datatype " << itkExposeEnumValue(this->GetComponentType()));
  }
...
MINCImageIO::Write(const void * buffer)
{
  ...
  switch (this->GetComponentType())
  {
    ...
    default:
      delete[] start;
      delete[] count;
      itkExceptionMacro(<< "Could not read datatype " << itkExposeEnumValue(this->GetComponentType()));
  }
