...
GiftiMeshIO ::WriteMeshInformation()
{
  ...
  if (this->m_UpdatePoints)
  {
    ...
    else if (this->m_FileType == FileEnum::BINARY && !this->m_UseCompression)
    {
    ...
    // set endian type
    if (this->m_ByteOrder == ByteOrderEnum::LittleEndian)
    {
      gifti_set_atr_in_DAs(m_GiftiImage, "Endian", "LittleEndian", dalist, 1);
    }
    else if (this->m_ByteOrder == ByteOrderEnum::BigEndian)
    {
