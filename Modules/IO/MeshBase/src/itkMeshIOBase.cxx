...
std::string
MeshIOBase ::GetFileTypeAsString(FileEnum t) const
{
  switch (t)
  {
    case FileEnum::ASCII:
...
std::string
MeshIOBase::GetByteOrderAsString(ByteOrderEnum t) const
{
  switch (t)
  {
...
MeshIOBase ::PrintSelf(std::ostream & os, Indent indent) const
{
  ...
  os << indent << "FileEnum: " << GetFileTypeAsString(m_FileType) << std::endl;
  os << indent << "ByteOrderEnum: " << GetByteOrderAsString(m_ByteOrder) << std::endl;
