...
ScalarImageToRunLengthFeaturesFilter<TImage, THistogramFrequencyContainer>::ScalarImageToRunLengthFeaturesFilter()
{
  ...
  requestedFeatures->push_back(RunLengthFeaturesFilterType::RunLengthFeatureEnum::LongRunEmphasis);
  requestedFeatures->push_back(RunLengthFeaturesFilterType::RunLengthFeatureEnum::GreyLevelNonuniformity);
  requestedFeatures->push_back(RunLengthFeaturesFilterType::RunLengthFeatureEnum::RunLengthNonuniformity);
  requestedFeatures->push_back(RunLengthFeaturesFilterType::RunLengthFeatureEnum::LowGreyLevelRunEmphasis);
  requestedFeatures->push_back(RunLengthFeaturesFilterType::RunLengthFeatureEnum::HighGreyLevelRunEmphasis);
  requestedFeatures->push_back(RunLengthFeaturesFilterType::RunLengthFeatureEnum::ShortRunLowGreyLevelEmphasis);
  requestedFeatures->push_back(RunLengthFeaturesFilterType::RunLengthFeatureEnum::ShortRunHighGreyLevelEmphasis);
  requestedFeatures->push_back(RunLengthFeaturesFilterType::RunLengthFeatureEnum::LongRunLowGreyLevelEmphasis);
  requestedFeatures->push_back(RunLengthFeaturesFilterType::RunLengthFeatureEnum::LongRunHighGreyLevelEmphasis);
...
ScalarImageToRunLengthFeaturesFilter<TImage, THistogramFrequencyContainer>::FullCompute()
{
  ...
  using InternalRunLengthFeatureName = typename RunLengthFeaturesFilterType::RunLengthFeatureEnum;
