...

{
  ...
  this->m_StopCondition = StopConditionEnum::MAXIMUM_NUMBER_OF_ITERATIONS;
...
GradientDescentOptimizerBasev4Template<TInternalComputationValueType>::PrintSelf(std::ostream & os, Indent indent) const
{
  ...
  os << indent << "StopCondition: "
     << itkExposeEnumValue(static_cast<typename NumericTraits<StopConditionEnum>::PrintType>(this->m_StopCondition))
     << std::endl;
